...
En caso de que un nodo falle, otro puede almacenar temporalmente los datos y, cuando el nodo original se recupera, todo se actualiza automáticamente, esta forma de operar asegura alta disponibilidad del sistema.