...
Si se cuenta con redundancia a nivel de **hardware**, **red**, **fuentes de poder** y **proveedores**, se garantiza una **alta disponibilidad integral** en el datacenter.  También es importante recalcar que si construimos un sistema computacional la idea es tener un **sistema espejo** que funcione en caso de uno se caiga también y la idea es que cada uno de estos estén en diferente rack y dando garantía que estén físicamente separados. 
