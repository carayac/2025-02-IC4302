-- Creación de tablas para el dataset de animales - MariaDB
...
-- Crear índices para mejorar rendimiento (sintaxis MariaDB)
CREATE INDEX idx_animal_dieta ON animal(dieta_id);
CREATE INDEX idx_animal_familia ON animal(familia_id);
CREATE INDEX idx_animal_habitat_animal ON animal_habitat(animal_id);
CREATE INDEX idx_animal_habitat_habitat ON animal_habitat(habitat_id);
CREATE INDEX idx_animal_predador_animal ON animal_predador(animal_id);
CREATE INDEX idx_animal_predador_predador ON animal_predador(predador_id);